...
class GaussianProcess:
    def __init__(self,
        ...
        """
        :param kernel: Kernel which will be used by the gaussian process to
                        calculate its covariance.
        :param array_dataset: array representing all the data points used to
                        calculate the posterior mean and variance of the GP.
        ...
        :param array_objective_function_values: array of the evaluations for
    ...
    def update_covariance_matrix(self) -> None:
        ...
        - self._array_dataset
        """
        self._covariance_matrix = self._kernel(self._dataset, self._dataset)
    ...
    def get_sample(self,
        ...
        """
        :param new_data_points: array representing all the data points at which
            we want to predict the posterior standard deviation of the GP.
        Its dimension is n x l, there are:
        - n elements in the dataset. Each row corresponds to a data point x_i
            (with 1<=i<=n), at which the objective function can be evaluated
        - each one of them is of dimension l (representing the number of
    ...
    def get_gp_mean_std(self,
        ...
        - mean: a column numpy array of size n x 1 with the estimation of
            the predicted mean of the gaussian process for all the points
            in data_points
        - a column numpy array of size n x 1 with the estimation of the
    ...
    def get_log_predictive_density(self,
        ...
        """
        :param data_points_test: array representing all the data points at which
         we want to predict the posterior mean of the GP.
        Its dimension is n x l, there are:
        - n elements in the dataset. Each row corresponds to a data point x_i
            (with 1<=i<=n), at which the objective function can be evaluated
        - each one of them is of dimension l (representing the number of
            variables required by the objective function)
        :param evaluations_test: array of the evaluations for all the elements
